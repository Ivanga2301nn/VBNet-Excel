...
Public Class Form_Tablo_new_AutoCadInserter
    ...
    Private Sub DrawBusbars(acDoc As Document, acCurDb As Database, basePoint As Point3d, circuits As List(Of clsTokow))
        Try
    ...
    Private Sub DrawPanelFrame(acDoc As Document, acCurDb As Database, basePoint As Point3d,
                               circuits As List(Of clsTokow), selectedTablo As String)
        Try
            ' =====================================================
            ' 1️ ИЗЧИСЛЯВАНЕ НА ОСНОВНИТЕ РАЗМЕРИ
            ' =====================================================
    ...
    ''' </summary>
    Private Sub DrawCircuits(acDoc As Document, acCurDb As Database, basePoint As Point3d, circuits As List(Of clsTokow))
        ...
        Try
            ...
            For Each circuit As clsTokow In circuits
    ...
    Private Sub DrawCircuitTexts(acDoc As Document, acCurDb As Database, basePoint As Point3d,
                         circuit As clsTokow, X As Double)
    ...
    Private Sub DrawBreakerBlock(acDoc As Document, acCurDb As Database, basePoint As Point3d,
                                circuit As clsTokow, X As Double, Y_Shina As Double)
    ...
    ''' </summary>
    Private Function GetControlDeviceConfig(circuit As clsTokow) As ControlDeviceConfig
    ...
    Public Sub DrawCircuitLines(X As Double, circuit As clsTokow, Y_Shina As Double)
    ...
    Private Sub DrawRCDBusbar(acDoc As Document, acCurDb As Database,
        ...
        Dim currentGroupCircuit As clsTokow = Nothing
        Try
            ' Обхождаме всички токови кръгове
            For Each circuit As clsTokow In circuits
    ...
    ''' </param>
    Private Sub DrawAnnotations(basePoint As Point3d, circuits As List(Of clsTokow))
    ...
    Private Sub DrawControlDevice(acDoc As Document, acCurDb As Database,
                                  circuit As clsTokow, X As Double, breakerY As Double)
        Try
            ' =====================================================
