...
"
    ...
    Sub ОБЯСНИТЕЛНА_ЗАПИСКА_PV(wordDoc As Word.Document,
        ...
        With Text
            ...
            Dim txtPokriv1 As String = ""
            Dim txtPokriv2 As String = ""
            Dim txtPokriv3 As String = ""
            Dim txtPokriv4 As String = ""

            txtPokriv1 = "Фотоволтаичните модули, монтирани върху покривите на сградите и постройките, са разположени така, че да не се нарушава целостта на покривната конструкция и изолационните слоеве." + vbCrLf
            txtPokriv1 += "При покриви с топлинна изолация са използвани материали с подходящ клас по реакция на огън, гарантиращи безопасност при възникване на пожар, като същевременно се запазват топлотехническите характеристики на покрива." + vbCrLf
            txtPokriv1 += "При покриви без външна топлинна изолация покривното покритие и хидроизолацията са също с необходимия клас по реакция на огън, съобразен с експозицията на външно огнево въздействие." + vbCrLf
            txtPokriv1 += "При монтаж на вградени (интегрирани) модули топлоизолацията и пароизолацията на покрива се предвиждат с необходимия клас по реакция на огън, осигуряващ безопасна експлоатация на системата." + vbCrLf
            txtPokriv1 += "Фотоволтаичните модули, предвидени за монтаж върху покривите на сградите и постройките, се разполагат на височина над покривното покритие не по-малка от минималното разстояние, определено от производителя, с цел осигуряване на необходимото им естествено охлаждане." + vbCrLf
            txtPokriv1 += "Отстоянието от фотоволтаичните модули до димни люкове, капандури, комини, шахти, куполи и други елементи, излизащи над покривната повърхност, е предвидено не по-малко от 1,0 m." + vbCrLf
            txtPokriv1 += "Не се допуска разполагане на фотоволтаични модули върху брандмауери и над вертикални пожарозащитни прегради, като отстоянието до такива прегради е предвидено не по-малко от 1, 0 m." + vbCrLf
            txtPokriv1 += "Не се предвижда монтаж на модули в огнеустойчиви фасадни участъци или на разстояние по-малко от 1, 0 m от евакуационни изходи." + vbCrLf
            txtZemya += "[ОТСТОЯНИЯ – МОЩНОСТ НАД 20 kW]" + vbCrLf
            txtPokriv2 += "Модулите са разположени на минимално разстояние не по-малко от 1,0 m от краищата (контура) на покрива, като оформят отделни модулни полета с размери, ненадвишаващи 40 m х 40 m. Между отделните полета са осигурени технологични проходи с широчина не по-малка от 1,50 m, позволяващи безопасен достъп, обслужване и намеса при аварийни ситуации." + vbCrLf
            txtZemya += "[ОТСТОЯНИЯ – МОЩНОСТ ДО 20 kW]" + vbCrLf
            txtPokriv3 += "При разполагане на модулите са осигурени отстояния не по-малки от 0, 50 m от краищата на покрива и не по-малки от 0, 10 m от надпокривни елементи като комини, капандури и димни люкове." + vbCrLf
            txtPokriv3 += "Монтажната конструкция за закрепване на фотоволтаичните модули е изпълнена от материали с клас по реакция на огън не по-нисък от А2, гарантиращи устойчивост при пожар и дълготрайна експлоатация." + vbCrLf
            txtPokriv3 += "Инверторите на фотоволтаичната централа са предвидени за монтаж върху негорими конструкции на височина не по-малка от 0, 30 m над покрива/терена, като са спазени необходимите отстояния не по-малки от 1,0 m от конструктивни елементи и строителни продукти с по-нисък клас по реакция на огън." + vbCrLf
            txtZemya += "[КАБЕЛНИ ТРАСЕТА]" + vbCrLf
            txtPokriv4 += "Кабелните трасета за постоянен ток, преминаващи през сградата, са проектирани с повишени изисквания за пожарна безопасност. Кабелите са положени в защитни тръби или канали с минимален клас по реакция на огън А2, като алтернативно са предвидени защитни строителни продукти, осигуряващи минимална огнеустойчивост EI 30 по цялата дължина на преминаване през конструктивни елементи и помещения на сградата." + vbCrLf
            txtPokriv4 += "В непосредствена близост до входа на сградата е предвидено табло с документация, съдържаща информация за местоположението на фотоволтаичните модули, инверторите, прекъсващите устройства и други основни елементи на системата." + vbCrLf
            txtPokriv4 += "До всеки вход на сградата е предвидено поставяне на предупредителен знак, указващ наличието на фотоволтаична електрическа централа, съгласно изискванията за пожарна безопасност." + vbCrLf
            ...
            Select Case dicObekt("Монтаж")
                ...
                Case "Покрив"
                    ...
                    AddParagraph(wordDoc, Text, True)
                    AddParagraph(wordDoc, txtPokriv1, False)
                    AddParagraph(wordDoc, txtPokriv2, False)
                    AddParagraph(wordDoc, txtPokriv3, False)
                    AddParagraph(wordDoc, txtPokriv4, False)
