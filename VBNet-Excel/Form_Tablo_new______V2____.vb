...
' 7. Form_Tablo_new_ValidationManager.vb
'    → Отговорност: Валидация на данни, проверка на конфигурации и логика за грешки 
'
' Този VB.NET клас съдържа част от логиката на модул за автоматизация в среда на AutoCAD,
' чиято основна цел е автоматично генериране и изчертаване на еднолинейни схеми на електрически табла
' по предварително подадени данни (структуриран списък от токови кръгове List(Of strTokow)).
