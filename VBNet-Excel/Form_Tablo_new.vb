...
#End Region
    ...
    Private Sub GetKonsumatori()
        ...
        Dim edt As Autodesk.AutoCAD.EditorInput.Editor = acDoc.Editor
    ...
    Private Sub TreeView1_DragOver(sender As Object, e As DragEventArgs) Handles TreeView1.DragOver
        ...
        Dim targetPoint As System.Drawing.Point = TreeView1.PointToClient(New System.Drawing.Point(e.X, e.Y))
